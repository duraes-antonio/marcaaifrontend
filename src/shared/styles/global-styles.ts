export const colorPrimary = '#8400F0';
export const colorPrimary2 = 'rgba(132,0,240,0.6)';

export const colorRed = 'rgba(255,0,0,0.6)';
...
export const ralewayItalic = 'Raleway-Italic';
